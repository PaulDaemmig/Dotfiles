...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    loaded = true,
    path = "/home/paul/.local/share/nvim/site/pack/packer/start/alpha-nvim",
    url = "https://github.com/goolord/alpha-nvim"
  },
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/home/paul/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  nvim = {
    loaded = true,
    path = "/home/paul/.local/share/nvim/site/pack/packer/start/nvim",
